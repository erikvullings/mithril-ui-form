      ...
      m(
        ...
        m('.nav-wrapper', [
          m(
            ...
            'a.github-corner[aria-label=View source on GitHub][href=https://github.com/erikvullings/mithril-ui-form]',
            m(
          ...
          m('a.hide-on-med-and-down.brand-logo[href=#]', { style: 'margin-left: 80px; ' }, 'MITHRIL-UI-FORM'),
          m(
            'ul.right',
            dashboardSvc
              .getList()
